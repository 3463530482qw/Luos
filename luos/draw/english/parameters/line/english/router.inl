namespace Gnik_luos {
    void Draw_line_cmd::router() {
        ...
        bool edge_on = (label.edge_top || label.edge_middle || label.edge_bottom
        ...
        if (private_routed &&
            ...
            private_label.edge_round == label.edge_round &&
            private_label.edge_round_notch == label.edge_round_notch &&
