namespace Gnik_luos {
    uint32_t Vulkan::find_memory_type(uint32_t type_filter, vk::MemoryPropertyFlags properties) {
        ...
        throw std::runtime_error("Vulkan::find_memory_type => No memory type matches the requirement");
    }
}
