namespace Gnik_luos {
    void Window_vulkan::submit_frame() {
        ...
        submit_info.setPWaitSemaphores(&*synchronization.image_available);
        ...
        submit_info.setPSignalSemaphores(&*synchronization.render_finished);

        vulkan->graphics_queue.submit(submit_info, *synchronization.frame_fence);

        vk::PresentInfoKHR present_info;
        present_info.setWaitSemaphoreCount(1);
        present_info.setPWaitSemaphores(&*synchronization.render_finished);
