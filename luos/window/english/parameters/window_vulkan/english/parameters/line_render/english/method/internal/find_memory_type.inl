namespace Gnik_luos {
    uint32_t Vulkan_line_render::find_memory_type(uint32_t type_filter, vk::MemoryPropertyFlags properties) {
        ...
        throw std::runtime_error("Vulkan_line_render::find_memory_type => No memory type matches the requirement");
    }
}
